...
const coffeeCategories = [
  {
    ...
    label: 'Black Coffee',
    items: [
       { id: 'c46', name: 'Piccolo Latte', price: 80, imgSrc: noData },
  { id: 'c47', name: 'Espresso Hot (Small)', price: 60, imgSrc: noData },
  { id: 'c48', name: 'Espresso Hot (Large)', price: 65, imgSrc: noData },
  { id: 'c49', name: 'Hot Americano (Small)', price: 60, imgSrc: noData },
  { id: 'c50', name: 'Hot Americano (Large)', price: 65, imgSrc: noData },
  { id: 'c51', name: 'Hot Latte (Small)', price: 75, imgSrc: noData },
  { id: 'c52', name: 'Hot Latte (Large)', price: 80, imgSrc: noData },
  { id: 'c53', name: 'Hot Cappuccino (Small)', price: 75, imgSrc: noData },
  { id: 'c54', name: 'Hot Cappuccino (Large)', price: 80, imgSrc: noData },
  { id: 'c55', name: 'Hot Mocha (Small)', price: 85, imgSrc: noData },
  { id: 'c56', name: 'Hot Mocha (Large)', price: 90, imgSrc: noData },
  { id: 'c57', name: 'Hot Caramel Macchiato (Small)', price: 85, imgSrc: noData },
  { id: 'c58', name: 'Hot Caramel Macchiato (Large)', price: 90, imgSrc: noData },
  { id: 'c59', name: 'Hot Cocoa (Small)', price: 80, imgSrc: noData },
  { id: 'c60', name: 'Hot Cocoa (Large)', price: 85, imgSrc: noData },
  { id: 'c61', name: 'Hot Special Nepali Coffee (Americano/Espresso)', price: 70, imgSrc: noData },
  { id: 'c62', name: 'Hot Special Nepali Coffee (Large)', price: 80, imgSrc: noData },
  { id: 'c63', name: 'Hot Nepali Tea (Milk)', price: 45, imgSrc: noData },
  { id: 'c64', name: 'Hot Nepali Tea (Black)', price: 25, imgSrc: noData },
  { id: 'c65', name: 'Hot Nepali Green Tea (Per Pot)', price: 80, imgSrc: noData },
  { id: 'c66', name: 'Hot Nepali Green Tea (Cup)', price: 35, imgSrc: noData },
  { id: 'c67', name: 'Blended Mocha with Ice Cream', price: 85, imgSrc: noData },
  { id: 'c68', name: 'Thai Green Tea', price: 35, imgSrc: noData },
  { id: 'c69', name: 'Thai Black Tea', price: 25, imgSrc: noData },
  { id: 'c70', name: 'Thai Milk Tea', price: 40, imgSrc: noData },
  { id: 'c71', name: 'Thai Herbal Tea', price: 65, imgSrc: noData },
  { id: 'c72', name: 'Hot Lemon Honey (Ginger)', price: 65, imgSrc: noData },
  { id: 'c73', name: 'Hot Chocolate', price: 70, imgSrc: noData }
    ]
  },
  {
    key: 'Milk Coffee',
